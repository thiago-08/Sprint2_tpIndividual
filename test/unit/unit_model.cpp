/**
 * @file unit_model.cpp
 * @brief Testes unitários da implementação concreta ModelImpl.
 *
 * Testes de caixa-branca que verificam construtores, operadores, ciclo de
 * vida e execução da simulação. Incluem diretamente `src/impl/` para
 * acessar atributos protegidos necessários às fixtures de teste.
 */
